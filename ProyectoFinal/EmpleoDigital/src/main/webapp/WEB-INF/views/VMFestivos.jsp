...
<form action="modificarFiesta" method="post">
<input type="hidden" name="fechaString" value="${stfecha}">
	<!-- Tipo de Festivos -->
	...
	<!-- Nombre de la festividad -->
		...
		<div class="col-sm-6 inf">
					...
					<div class="form-group">
					  ...
					  <input value="${nombre}" type="text" class="form-control" name="nombre"/>
					</div>
		</div>
		<div class="col-sm-3">
		</div>
	   ...
	   <div class="row" id="calendarioFestivos">
        ...
        <div class="col-sm-6 planner">
           <div class="calendarioFest">
           	...
           	<input value="${stfecha}" type="text" id="datepicker" name="fecha">
