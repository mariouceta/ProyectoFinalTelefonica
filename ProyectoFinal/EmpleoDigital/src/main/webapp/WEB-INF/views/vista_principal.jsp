		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-md-4">
					...
					<img id="logo izquierda" src="img/empleo.png" >
				...
				<div class="col-md-4">
					...
					<img id="logo derecha" src="img/fundacion.png" align="right">
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-2">
			...
			<img id="logo izquierda" src="img/LogoEquipo.png" width= 100%; height= 100%;>
